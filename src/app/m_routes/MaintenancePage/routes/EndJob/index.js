...
import maintenanceViewedList from "../../data/maintenanceViewedList";
...
class EndJob extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      allBuilding: maintenanceViewedList,
      maintenanceList: maintenanceViewedList,
...
export default connect(mapStateToProps)(EndJob);
