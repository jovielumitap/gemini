...
import ClosedList from "./ClosedReportList";
import AppModuleHeader from "components/AppModuleHeader/index";
import CustomScrollbars from "util/CustomScrollbars";


class ClosedReport extends Component {
  ...
  showBuildings = ({ currentBuilding, maintenanceList }) => {
    return (
      <ClosedList maintenanceList={maintenanceList}
      />
    );
  };
  onSearch = (e) => {
...
export default connect(mapStateToProps)(ClosedReport);
