...
import SentReportList from "./SentReportList";
import AppModuleHeader from "components/AppModuleHeader/index";
import CustomScrollbars from "util/CustomScrollbars";


class SentReport extends Component {
  ...
  showBuildings = ({ currentBuilding, maintenanceList }) => {
    return (
      <SentReportList maintenanceList={maintenanceList}
      />
    );
  };
  onSearch = (e) => {
...
export default connect(mapStateToProps)(SentReport);
