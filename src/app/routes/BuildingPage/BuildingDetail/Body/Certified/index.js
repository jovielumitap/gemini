...
class CertifiedList extends Component {
  ...
  render() {
    const { subBuildingList, addBuildingState, addCertifiedState, selectedSubBuildings, alertMessage, showMessage, noContentFoundMessage, currentBuilding } = this.state;
    return (
      <div className="app-wrapper">
        ...
        <AddCertificate
          ...
          onCertificateClose={this.onCertifiedClose}
        />
        <Snackbar
