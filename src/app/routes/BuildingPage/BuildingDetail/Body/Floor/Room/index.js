...
class RoomList extends Component {
  ...
  render() {
    const { subBuildingList, addBuildingState, addRoom, selectedSubBuildings, alertMessage, showMessage, noContentFoundMessage, currentBuilding } = this.state;
    return (
      <div className="app-wrapper">
        ...
        <AddRoom
          open={addRoom}
          onSaveRent={this.onSaveRoom}
          onRentClose={this.onRoomClose}
        />
        <Snackbar
