      ...
      <Modal className="modal-box" isOpen={open}>
        ...
        <div className="modal-box-content">
          <div className="row no-gutters">
              ...
              <div className="col-md-8 p-0">
                <FormControl className="w-100 mb-2">
                  <Select
                    ...
                    input={<Input/>}
                  >
                    <MenuItem value={"intend1"}>HIGH</MenuItem>
                    <MenuItem value={"intend2"}>MIDDLE</MenuItem>
                    <MenuItem value={"intend3"}>LOW</MenuItem>
                  </Select>
                </FormControl>
              </div>
            </div>
            ...
            <div className="row col-md-12 col-12 p-0 mb-2">
              <div className="col-md-4 text-right p-relative">
                <label className="align-center font-size-18">REMIND</label>
              </div>
              <div className="col-md-8 p-0">
                <FormControl className="w-100 mb-2">
                  <Select
                    ...
                    input={<Input/>}
                  >
                    <MenuItem value={"intend1"}>NOT REMIND</MenuItem>
                    <MenuItem value={"intend2"}>ONE TIME</MenuItem>
                    <MenuItem value={"intend3"}>EVERY DAY OF DELAY</MenuItem>
                    <MenuItem value={"intend3"}>AFTER THREE DAYS OF DELAY</MenuItem>
                  </Select>
                </FormControl>
              </div>
            </div>
            ...
            <div className="row col-md-12 col-12 p-0 mb-2">
              <div className="col-md-4 text-right p-relative">
                <label className="align-center font-size-18">REMINDER TO</label>
              </div>
              <div className="col-md-8 p-0">
                <FormControl className="w-100 mb-2">
                  <Select
                    ...
                    input={<Input/>}
                  >
                    <MenuItem value={"intend1"}>ALL</MenuItem>
                  </Select>
                </FormControl>
              </div>
            </div>
