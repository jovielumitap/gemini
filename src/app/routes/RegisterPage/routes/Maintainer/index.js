...
class Maintainer extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      noContentFoundMessage: "No Maintainer found",
      alertMessage: "",
      showMessage: false,
      drawerState: false,
      searchKey: "",
            ...
            <div className="module-box-content">
              <CustomScrollbars className="module-list-scroll scrollbar"
                ...
                {maintainers.length === 0 ?
                  ...
                  : this.showRegisters(maintainers)
                }
...
const mapStateToProps = ({ settings, users }) => {
  ...
  const { maintainers } = users.users;
  return { width, maintainers };
};
