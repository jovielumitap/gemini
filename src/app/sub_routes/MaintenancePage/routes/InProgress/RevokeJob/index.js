...
class RevokeJob extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      drawerState: false,
      searchKey: "",
      allBuilding: subWorkers,
      maintenanceList: subWorkers,
    };
  }
  ...
  showBuildings = ({ currentBuilding, maintenanceList }) => {
    return (
      <SubWorkerList maintenanceList={maintenanceList}
      />
    );
  };
  onSearch = (e) => {
...
export default connect(mapStateToProps)(RevokeJob);
